...
class Best_selling_product_urls_model extends CI_Model{

	var $table_name = 'at_best_selling_page_product_urls';
	 ...
	 */
	public function select_records($fields = '*', $limit = 200, $offset= 0,$where_condition = null ){				
