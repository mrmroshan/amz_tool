...
dhtmlxAjax.get(url,function(loader){
    ...
    var url2 = "<?php echo site_url("best_selling_urls/collect_product_url_from_each_page/".$project_id)?>";
    ...
    dhtmlxAjax.get(url2,function(loader){
        ...
        var url3 = "<?php echo site_url("best_selling_urls/get_product_details/".$project_id)?>";
